...
3. Run the appropriate command based on your requirement:
   ...
   **To check quota for the deployment**
    ...
    ```sh
    curl -L -o quota_check_params.sh "https://raw.githubusercontent.com/microsoft/content-generation-solution-accelerator/main/infra/scripts/pre-provision/quota_check_params.sh"
